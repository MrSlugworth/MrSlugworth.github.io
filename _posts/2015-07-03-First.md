...
**Proposition:** The minimal polynomial for the matrix $$A$$ with entries in a field $$\mathbb{F}$$ splits into linear factors over $$\mathbb{F}$$ iff $$A$$ is diagonalizable.
...
For the other direction, suppose that the minimal polynomial for $$A$$ splits into linear factors. 
...
Cum sociis natasfasfdoque penatibus et magnis <a href="#">dis parturient montes</a>, nascetur ridiculus mus. *Aenean eu leo quam.* Pellentesque ornare sem lacinia quam venenatis vestibulum. Sed posuere consectetur est at lobortis. Cras mattis consectetur purus sit amet fermentum.
